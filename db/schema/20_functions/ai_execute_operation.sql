...
BEGIN
    ...
    v_allowed:=case v_entity
      when 'work_order' then array['Deadline','Data_Receptie','Nume_Pacient','Nume_Partener','items','case','Contract','Status','Discount','Tehnician_Model','Tehnician1_Modelare','Tehnician2_Cer_Fin','Status_Model','Status_Modelare','Status_Cer_Fin','Paid_Model','Paid_Modelare','Paid_Cer_Fin','Settlement_Model','Settlement_Modelare','Settlement_Cer_Fin','Locked']
