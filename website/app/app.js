...
const TOOTH_LAYOUT={
  // Calibrated from the crown contours: adjacent outlines meet without fill overlap.
  // Keep these contact positions in sync with the tooth geometry regression tests.
  11:{x:215.024,y:43.659,r:-2,sx:1.33198,sy:1.41932},
  21:{x:264.314,y:43.659,r:2,sx:1.33198,sy:1.41932},
  12:{x:175.31,y:53.799,r:-23,sx:1.38657,sy:1.4084},
  22:{x:304.426,y:53.901,r:23,sx:1.38657,sy:1.4084},
  13:{x:142.03,y:79.683,r:-36,sx:1.57217,sy:1.41932},
  23:{x:335.836,y:78.331,r:36,sx:1.57217,sy:1.41932},
  14:{x:115.478,y:115.087,r:-53,sx:1.28831,sy:1.31014},
  ...
  48:{x:81.59,y:439.462,r:-90,sx:1.63768,sy:1.61584},
  38:{x:400.41,y:431.611,r:90,sx:1.63768,sy:1.61584},
  47:{x:84.423,y:500.855,r:-87,sx:1.67043,sy:1.6486},
  37:{x:397.455,y:495.646,r:87,sx:1.67043,sy:1.6486},
  46:{x:92.266,y:567.521,r:-79,sx:1.62676,sy:1.61584},
  36:{x:389.41,y:564.024,r:79,sx:1.62676,sy:1.61584},
  45:{x:108.852,y:628.008,r:-65,sx:1.35381,sy:1.37565},
  35:{x:372.515,y:625.641,r:65,sx:1.35381,sy:1.37565},
...
function toothGlyphMarkup(tooth,color="#d2d2d0",selected=false,interactive=false){
  ...
  // Incisal edges are broad and gently curved; the crown tapers inward.
  if(pos===1 && upper){
    crown=`<path class="tooth-svg-shape" d="
      M-18,-16 C-12,-18 -5,-17.8 0,-17.8
      C7,-18 13,-18 18,-16 C20,-12 18.5,-4 16,2
      C13,8 8,15 3,19 C1,20.5 -2,20 -4,18
      C-9,13 -14,7 -16,1 C-18.5,-5 -19.5,-12 -18,-16 Z"></path>`;
    anatomy=`
      <path class="tooth-anatomy" d="M-12,-10 C-7,-14 5,-14 12,-10"></path>
      <path class="tooth-anatomy" d="M-7,1 C-5,4 -5,8 -3,11 M7,1 C5,5 5,8 3,11"></path>`;
  }
  else if(pos===1){
    crown=`<path class="tooth-svg-shape" d="
      M-11,-16 C-6,-18 6,-18 11,-16
      C12,-10 9,-1 6,7 C4,13 2.5,17 0,18
      C-3,18 -5,13 -7,7 C-10,-1 -12,-10 -11,-16 Z"></path>`;
    anatomy=`
      <path class="tooth-anatomy" d="M-7,-11 C-3,-13 3,-13 7,-11"></path>
      <path class="tooth-anatomy" d="M-4,-5 C-4,0 -2,5 -2,9 M4,-5 C3,1 2,5 1,9"></path>`;
  }
  else if(pos===2 && upper){
    crown=`<path class="tooth-svg-shape" d="
      M-14,-15 C-9,-17 -2,-17.5 4,-17 C9,-16.5 13,-15 15,-12
      C16,-7 13,-1 10,6 C8,11 5,16 1,17
      C-2,18 -7,14 -10,9 C-13,4 -15,-4 -15,-10
      C-15,-12 -15,-14 -14,-15 Z"></path>`;
    anatomy=`
      <path class="tooth-anatomy" d="M-9,-10 C-4,-13 5,-12 10,-9"></path>
      <path class="tooth-anatomy" d="M-6,0 C-4,3 -4,7 -2,10 M6,0 C4,4 4,7 2,10"></path>`;
  }
  else if(pos===2){
    crown=`<path class="tooth-svg-shape" d="
      M-12,-15 C-7,-17 5,-18 10,-16
      C12,-13 10,-5 7,2 C4,8 2,15 -1,17
      C-4,18 -7,11 -9,5 C-11,-1 -13,-10 -12,-15 Z"></path>`;
    anatomy=`
      <path class="tooth-anatomy" d="M-8,-10 C-4,-12 3,-13 7,-11"></path>
      <path class="tooth-anatomy" d="M-5,-4 C-4,1 -3,5 -2,8 M4,-4 C3,1 1,5 0,9"></path>`;
  }
